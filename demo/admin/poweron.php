...
switch ($messgaeType) {
 ...
 //       print_r('');
  ...
  //print_r('{acceptDevice: BP- GL , hbrate: 100, BP：” C0:15:91:A1:90:8A”,GL:” B0:A1:11:31:A1:81”, WIFIAP_SSID:”FAST_HONGLAJIAO” , WIFIPWD:”fast1234” SERVERURL=”api.yicheng.com/index” '}
        break;
    case 'exam'://上传血压
        print_r('{resultcode:0,desc: "success"}');
        //print_r('{acceptDevice: BP- GL , hbrate: 100, BP：” C0:15:91:A1:90:8A”,GL:” B0:A1:11:31:A1:81”, WIFIAP_SSID:”FAST_HONGLAJIAO” , WIFIPWD:”fast1234” SERVERURL=”api.yicheng.com/index” '}
