...
class DemoController extends Controller {
	...
	public function index(){
		...
		//$Infoarr['bloodsugar']    =  sprintf("%.1f",$Infoarr['bloodsugar']);
		//检测血糖状态
		...
		$info = \Mobileselfdoctor\Model\Health_data_analyseModel::getinfo($Infoarr['bloodsugar']);
		...
		if ($insertid) {
			...
			$remotedata = array(
					...
					'analysedata'=>array(
							'conclusion'=>$analyseDatas['analysedata']['conclusion'],
							'reason'=>$analyseDatas['analysedata']['reason'],
							'suggest'=>$analyseDatas['analysedata']['suggest'],
					),
